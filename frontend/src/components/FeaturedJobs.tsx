  ...
  return (
    <section>
      <div className="flex justify-between items-baseline mb-6">
        ...
        <Link href="/jobs" className="text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300">
          View all jobs →
        </Link>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {isLoading ? (
          ...
          <div className="col-span-3 text-center py-8">
            <p className="text-gray-500 dark:text-gray-400">No job listings found. Check back soon!</p>
          </div>
        )}
      </div>
    </section>
