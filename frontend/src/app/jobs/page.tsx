          ...
          <>
            ...
            {data.length === 0 ? (
              <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 text-center">
                <p className="text-gray-700 dark:text-gray-300">No jobs found matching your criteria.</p>
                <p className="mt-2 text-gray-600 dark:text-gray-400">Try broadening your search terms or exploring our featured jobs.</p>
              </div>
            ) : (
