...
export type GetJobsQuery = { __typename?: 'query_root', jobs: Array<{ __typename?: 'jobs', location: string, title: string, user_id: any, created_at: any, description: string, id: any }> };
