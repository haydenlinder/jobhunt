...
type Documents = {
  ...
  '\n  mutation UpdateApplication($id: uuid = "", $email: String = "", $linkedin: String = "", $website: String = "", $name: String = "") {\n    update_applications_by_pk(pk_columns: {id: $id}, _set: {email: $email, linkedin: $linkedin, website: $website, name: $name}) {\n      id\n    }\n  }\n': typeof types.UpdateApplicationDocument;
